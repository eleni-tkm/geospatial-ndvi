...
- Since the Copernicus Land Monitoring Service (CLMS) - CLMS 300m product **is not exposed via the openEO API**, to run this code successfuly the user needs to:
  - **Manually download** the file `c_gls_NDVI300_202508110000_GLOBE_OLCI_V3.0.1_cog` from the [Sentinel Browser](https://browser.dataspace.copernicus.eu/?zoom=5&lat=50.16282&lng=20.78613&themeId=DEFAULT-THEME&visualizationUrl=U2FsdGVkX19xPJJPwjuRSYTGaBTNRNiqSs1GnaIKEsNVmg%2Bp0UjcS36IBEtLv4AEM8wCeXrH6utpd7qjlcF2N3kdALzNZPUG3wD1qzvu4B810ugaHJSbFNVl8YVkzU9F&datasetId=S2_L2A_CDAS)
